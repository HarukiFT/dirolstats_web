...
const PromoStats: React.FC = () => {
    ...
    useEffect(() => {
        ...
        axiosRequest.get<{_id: string, value: number}[]>(`/stats/promo?from=${appContext.fromDate.toISOString()}&to=${appContext.toDate.toISOString()}`).then(response => {
