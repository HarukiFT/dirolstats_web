...
const ClothStats: React.FC = () => {
    ...
    useEffect(() => {
        ...
        axiosRequest.get<{_id: string, value: number}[]>(`/stats/cloth?from=${appContext.fromDate.toISOString()}&to=${appContext.toDate.toISOString()}`).then(response => {
